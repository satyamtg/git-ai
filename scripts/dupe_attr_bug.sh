...
git add -A
git commit -m "Add format_string function"

# Save default branch name after first commit
...
git add -A
git commit -m "AI adds reverse_string function"

# Switch back and squash-merge
git checkout "${default_branch}"
git merge --squash feature
git add -A
git commit -m "Squash merge: add reverse_string"
